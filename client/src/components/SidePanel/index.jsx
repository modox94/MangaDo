  ...
  return (
    <div className={styles.sideContainer}>
      ...
      <details>
        ...
        <input onChange={handlerTitleTranslate} type="text" value={translateMarkTitle} />
        <button onClick={() => handlerAddMark('translate', translateMarkTitle)}> Добавить </button>
      ...
      <details>
        ...
        <input onChange={handlerTitleDecor} type="text" value={decorteMarkTitle} />
        <button onClick={() => handlerAddMark('decor', decorteMarkTitle)}> Добавить </button>
      ...
      <details>
        ...
        <button onClick={() => handlerAddMark('edit', editMarkTitle)}> Добавить </button>
      ...
      <Modal active={modalActive} setActive={setModalActive}>
        <input onChange={handlerCurentMessage} type="text" value={curentMessage} />
        <button onClick={handlerAddMessage}> Добавить </button>
        {markArr.find(el => el._id === curentOpenId)?.messages.map((message) => {
          return (
            <div>
